...
<head>
    <meta charset="utf-8">
    <title>D̩tail de la vente</title>
...
<body>
    <div class="section">
        <div class="div-block">
            ...
            <a href="index.html" class="lien-block w-inline-block">
    ...
    <div class="conteneur">
        <h1 class="conteneur conteneur-1 titre1">D̩tail de la vente</h1>
    </div>
        ...
        <div class="col">
            <div class="conteneur-7 conteneur">
                ...
                <div class="disposition-grille grille">
                    ...
                    <h4>Fin de l'ench̬re</h4>
                    <p class="paragraphe">09/10/2018</p>
                    <h4>Retrait</h4>
                    <p class="paragraphe">
                        10 all̩e des Alouettes
