...
<head>
    <meta charset="utf-8">
    <title>Vous avez remportÃ© la vente</title>
...
<body>
    ...
    <div class="colonnes conteneur">
        <h1 class="conteneur conteneur-1 titre1">Vous avez remportÃ© la vente !</h1>
    </div>
        ...
        <div class="col col-13">
            <div class="conteneur-7 conteneur">
                ...
                <div class="disposition-grille grille">
                    ...
                    <h4>Retrait</h4>
                    <p class="paragraphe">
                        10 allÃ©e des Aloutettes
                        <br> 44800 Saint Herbain
                    </p>
                    <h4>Vendeur</h4>
    ...
    <div class="conteneur-10 conteneur">
        <a href="#" class="bouton">Retour Ã  l'accueil</a>
    </div>
