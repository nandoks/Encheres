...
<div class="section">
	<div class="div-block">
		...
		<a href="${pageContext.request.contextPath}/authentification"
		...
		<form id="email-form" name="email-form" data-name="Email Form" class="clearfix" method="post" action="modificationCompte">
			<div class="rangee">
				...
				<div class="colonne col-6">
					...
					<input type="hidden" name="no_utilisateur" value="${utilisateur.numeroUtilisateur}" /> <span id='message'></span>
				</div>
			</div>
			<input type="submit" value="Enregistrer " id="enregistrer" data-wait="Veuillez patienter... " class="bouton-soumettre-3 s-bouton "/> <span id='message'></span>
		</form>
			<button><a href="suppressionCompte?no_utilisateur=${utilisateur.numeroUtilisateur}" onclick="alerteSupprimer()" id="supprimer" data-wait="Veuillez patientez..." class="bouton-soumettre-4 s-bouton">Supprimer mon compte</a></button>		
