...
public class ArticleVenduDAOJdbcImpl implements ArticleVenduDAO {
	...
	private static final String SQL_SELECT_ALL = "SELECT nom_article, prix_initial, date_fin_encheres, pseudo, "
			+ "a.no_utilisateur, libelle, no_article, date_debut_encheres"
	...
	private final String SQL_SELECT_BY_CATEGORIE = "SELECT nom_article, prix_initial, date_fin_encheres, pseudo, a.no_utilisateur, libelle, no_article, date_debut_encheres "
			+ " FROM articles_vendus a INNER JOIN utilisateurs u ON a.no_utilisateur = u.no_utilisateur "
			+ " INNER JOIN categories c ON a.no_categorie = c.no_categorie WHERE libelle = ?";

	private final String SQL_SELECT_BY_MOT_CLE = "SELECT nom_article, prix_initial, date_fin_encheres, pseudo, a.no_utilisateur, libelle, no_article, date_debut_encheres "
			+ " FROM articles_vendus a INNER JOIN utilisateurs u ON a.no_utilisateur = u.no_utilisateur "
			+ " INNER JOIN categories c ON a.no_categorie = c.no_categorie where nom_article LIKE ?";

	private final String SQL_SELECT_BY_MOT_CLE_ET_CATEGORIE = "SELECT nom_article, prix_initial, date_fin_encheres, pseudo, a.no_utilisateur, libelle, no_article, date_debut_encheres  "
			+ " FROM articles_vendus a INNER JOIN utilisateurs u ON a.no_utilisateur = u.no_utilisateur "
			+ " INNER JOIN categories c ON a.no_categorie = c.no_categorie where nom_article LIKE ? AND libelle = ?";

	private final String SQL_SELECT_BY_OUVERT = "SELECT nom_article, prix_initial, date_fin_encheres, pseudo, a.no_utilisateur, libelle, no_article, date_debut_encheres  "
			+ " FROM articles_vendus a INNER JOIN utilisateurs u ON a.no_utilisateur = u.no_utilisateur "
